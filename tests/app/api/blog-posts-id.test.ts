...
describe('GET /api/blog-posts/[id]', () => {
  ...
  it('returns post by id', async () => {
    ...
    const req = new Request('http://localhost/api/blog-posts/1') as NextRequest
  ...
  it('returns 404 when post not found', async () => {
    ...
    const req = new Request('http://localhost/api/blog-posts/999') as NextRequest
...
describe('PUT /api/blog-posts/[id]', () => {
  ...
  it('updates post for authenticated admin', async () => {
    ...
    mockPrisma.blogPost.findUnique.mockResolvedValue({ id: '1', title: 'Old' })
